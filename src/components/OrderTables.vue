...
const items = computed(() => [
    ...
    },
    {
        ...
        destinationAddress: '789 Oak St, Anytown, USA',
        status: 'Delivered',
        items: [
            { id: 3, name: 'Product C', quantity: 3, price: '$40' }
        ],
        total_belanja: "3.000.000",
        tanggal_beli: '2021-10-12',
        foto_produk: 'https://via.placeholder.com/150'
    },
    {
        id: 4,
        customerName: 'Bob Johnson',
        destinationAddress: '1011 Pine St, Anytown, USA',
        status: 'Pending',
        items: [
            { id: 4, name: 'Product D', quantity: 4, price: '$50' }
        ],
        total_belanja: "4.000.000",
        tanggal_beli: '2021-10-13',
        foto_produk: 'https://via.placeholder.com/150'
    }
])
